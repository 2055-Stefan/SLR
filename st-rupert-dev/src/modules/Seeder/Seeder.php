...
class Seeder
{
    ...
    {
        $service1 = new MunicipalService(1, "Bauamt", "Bauabteilung", 2024, "+43 123 456");
        ...
        $service2 = new MunicipalService(2, "Meldeamt", "Einwohnerwesen", 2023, "+43 987 654");
        ...
        $service3 = new MunicipalService(3, "Umweltamt", "Natur & Grünflächen", 2022, "+43 555 000");
